...
* `cep_api_pro` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `CEP_API_Pro` - executable or bundle name on disk.
* `CEP_API_Pro` - display name shown in window titles and about app dialogs.
